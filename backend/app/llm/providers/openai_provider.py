...
class OpenAIProvider(BaseLLM):
    """Concrete implementation for OpenAI (ChatGPT) models"""
    
    def __init__(self, model_name: str = "gpt-4o-mini", api_key: str = None, temperature: float = 0.7, max_tokens: int = 2048):
